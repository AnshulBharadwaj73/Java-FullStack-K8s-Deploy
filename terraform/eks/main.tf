# Read VPC outputs (vpc_id, subnet IDs) from the VPC stack's state.
...
resource "aws_eks_cluster" "this" {
  ...
  vpc_config {
    # Control plane ENIs live in both public + private subnets for HA.
...
# ============================================================
# IRSA role for the EBS CSI driver addon (so PVCs work)
# ============================================================
